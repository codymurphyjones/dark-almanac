    ...
    <div className="dark flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-300 md:text-xl">
                  Dive into the world of gaming theories and strategies. Join the community and start crafting your own
                  theories.
                </p>
              </div>
            </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-800">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold text-center mb-8">Latest Theories</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">
                    Dive into the lore and hidden mechanics of Dark Souls and uncover the secrets of Lordran.
                  </p>
                  <Link className="mt-4 inline-flex text-sm font-medium hover:underline underline-offset-4" href="#">
                    Read More
                  </Link>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-300">
                    Explore the interconnected world of Hollow Knight and discover the hidden paths and secrets.
                  </p>
                  <Link className="mt-4 inline-flex text-sm font-medium hover:underline underline-offset-4" href="#">
                    Read More
                  </Link>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-300">
                    Uncover the deeper themes and messages behind the story of The Last of Us.
                  </p>
                  <Link className="mt-4 inline-flex text-sm font-medium hover:underline underline-offset-4" href="#">
                    Read More
                  </Link>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-300">
                    "This website has helped me understand the deeper mechanics of my favorite games. It's a must-visit
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-300">
                    "The community here is amazing. I've learned so much from the discussions and theories shared by
                    other users."
                  </p>
                </CardContent>
              </Card>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-gray-800">
        <p className="text-xs text-gray-500">© 2024 Game Theory Craft. All rights reserved.</p>
